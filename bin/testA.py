...
lpltS = "/Users/tknitter/w/gitWS/lplTrade/bin/lpltS.py"
prog = "/Users/tknitter/w/gitWS/lplW/bin/python3 " + lpltS + " "
   ...
   for openBars in openCloseBuySellBars:
      for closeBars in closeBuySellBars:
         ...
         for stock in symbols:
            ...
            # Create files based off of the stocks line in the profile, algo and date
            cmd = prog + args + " -c " + cdp + " -p " + tdp + " > " + outFile
